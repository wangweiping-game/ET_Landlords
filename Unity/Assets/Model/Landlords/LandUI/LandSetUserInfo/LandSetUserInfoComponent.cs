...
namespace ETModel
{
    ...
    public class LandSetUserInfoComponent : Component
    {
        ...
        public void Awake()
        {
            ...
            LandLobbyComponent landlogin = Game.Scene.GetComponent<UIComponent>().Get(LandUIType.LandLobby).GetComponent<LandLobbyComponent>();
            phone.text = landlogin.phone.text;
            email.text = landlogin.email.text;
            sex.text = landlogin.sex.text;
